...
$(function(){
	$(".pop_form input").click(function(){
		$(this).addClass("hover").parent("li").siblings("li").find("input").removeClass("hover");
		$(this).parent("li").siblings("li").find("select").removeClass("hover");
	})
	$(".pop_form select").click(function(){
		$(this).addClass("hover").parent("li").siblings("li").find("input").removeClass("hover");
		$(this).parent("li").siblings("li").find("select").removeClass("hover");
	})
	...
	$("#menuNav_ li ~ div").hover(function(){
		$(this).show();
		},function(){
					$(this).hide();
		});
		
		$("#navP_ a").click(function(){
			$(this).addClass("hover").siblings().removeClass("hover");
		});
		
	$(".lou_l li").hover(function(){
		$(this).addClass("hover").siblings().removeClass("hover");
		$(".lou_r:eq("+$(this).index()+")").show().siblings(".lou_r").hide();
		},function(){
...
//top隐藏层
$(function(){
	$(".top_hb,.topb2b_hb").mouseover(function(){
		$(this).addClass("hbhover"); 	
		$(this).find("ul").css("display","block");	
	});
	$(".top_hb,.topb2b_hb").mouseout(function(){
...
$(function(){
	$("#b2bMallTab_").mouseover(function(){
		$(this).find(".phone").addClass("hbhover"); 	
	}).mouseout(function(){
		$(this).find(".phone").removeClass("hbhover"); 	
	});
});
...
$(function(){
	...
	//地市切换
$(function(){
	$(".ahyx_dsqh").click(function(event)
		{
			$(this).parent().next("div.ahyx_qhds").show();
